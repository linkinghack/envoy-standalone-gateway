...
| **S7 (260725)** | M1 | static 模式与进程托管 | M-PROC（发现/启动/接管/崩溃退避）；hot restart 协调协议（DL1/DL4/DL6 实测定）；static Apply 路径与生效语义 | [下发层](../system_design/260717-1-deliver-layer-design.md) §4~§5、[M1 工程实施计划](engineering_plan/260722-1-m1-completion-plan.md) | S2/S6；进行中（2026-07-22 启动，[任务追踪](sprints/260725/plan_todos_trace.md)） |
