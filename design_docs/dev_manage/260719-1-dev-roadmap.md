...
| **S6 (260724)** | M1 | 控制台 P0 | React + TypeScript + Vite + shadcn/ui；配置五对象 CRUD（表单+YAML）、运行状态视图、简版发布流、证书库、专家模式、编译产物、系统信息 | [控制台 API](../system_design/260717-3-console-api-design.md) §2、§6、[M1 工程实施计划](engineering_plan/260722-1-m1-completion-plan.md) | S5；进行中（2026-07-22 启动，[任务追踪](sprints/260724/plan_todos_trace.md)） |
